                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title border-bootom-none mb-30 d-flex align-items-center justify-content-between">
                                    ...
                                    <!-- <a href="{{ url('add-teacher') }}">
                                        <button class="ct_custom_btn1 mx-auto">Add New Teacher</button>
                                    </a> -->
                                </div>
                                <table class="table teacher-data-table table-responsive table-bordered table-hover mb-0" id="userTable">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Profile</th>
...
<script type="text/javascript">
    $(function() {
        var table = $('.teacher-data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('users/list-teacher') }}",
            columns: [{
                    data: 'serial_number',
                    name: 'serial_number'
