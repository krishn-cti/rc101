                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Teacher</h3>
                                    <a href="{{url('users/list-teacher')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('users/update-teacher')}}" method="POST" id="editTeacher" enctype="multipart/form-data">
                                    @csrf
