                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Add Physics, Geometry, and Robot Combat</h3>
                                    <a href="{{url('cms/lessons/physics-geometry-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/lessons/physics-geometry-save')}}" method="POST" id="addPhysicsGeometry" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
