                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Add Electrical engineering and robot combat</h3>
                                    <a href="{{url('cms/lessons/electrical-engineering-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/lessons/electrical-engineering-save')}}" method="POST" id="addElectricalEngineering" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
...
<script>
    $(document).ready(function() {
        $('#addElectricalEngineering').validate({
            ignore: [],
            rules: {
                lesson_title: {
                    required: true,
