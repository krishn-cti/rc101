                        ...
                        <div class="card">
                            <div class="card-body">
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Fusiong</h3>
                                    <a href="{{url('cms/lessons/fusion-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/lessons/fusion-update')}}" method="POST" id="editFusion" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{$fusionData->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="lesson_title" class="mb-2">Lesson Title</label>
                                                <input type="text" class="form-control ct_input" name="lesson_title" placeholder="Lesson Title" value="{{ old('lesson_title', $fusionData->lesson_title) }}">
                                                @error('lesson_title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="lesson_description" id="lesson_description" placeholder="Lesson Description">{{ old('lesson_description', $fusionData->lesson_description) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                @if(!empty($fusionData->lesson_cover_image) && file_exists(public_path('cms_images/lesson/fusion/' . $fusionData->lesson_cover_image)))

                                                <div id="imagePreviewWrapper" class="mt-2" style="display: 'block';">
                                                    <img id="imagePreview" src="{{ asset('cms_images/lesson/fusion/'.$fusionData->lesson_cover_image) }}" alt="Current Image" style="width: 100px; height: 100px; border-radius: 8px;">
                                                </div>
                                                @else
