                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Add Soldering</h3>
                                    <a href="{{url('cms/lessons/soldering-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/lessons/soldering-save')}}" method="POST" id="addSoldering" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
