                        ...
                        <div class="card">
                            <div class="card-body">
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Soldering</h3>
                                    <a href="{{url('cms/lessons/soldering-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/lessons/soldering-update')}}" method="POST" id="editSoldering" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{$solderingData->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="lesson_title" class="mb-2">Lesson Title</label>
                                                <input type="text" class="form-control ct_input" name="lesson_title" placeholder="Lesson Title" value="{{ old('lesson_title', $solderingData->lesson_title) }}">
                                                @error('lesson_title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="lesson_description" id="lesson_description" placeholder="Lesson Description">{{ old('lesson_description', $solderingData->lesson_description) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                @if(!empty($solderingData->lesson_cover_image) && file_exists(public_path('cms_images/lesson/soldering/' . $solderingData->lesson_cover_image)))

                                                <div id="imagePreviewWrapper" class="mt-2" style="display: 'block';">
                                                    <img id="imagePreview" src="{{ asset('cms_images/lesson/soldering/'.$solderingData->lesson_cover_image) }}" alt="Current Image" style="width: 100px; height: 100px; border-radius: 8px;">
                                                </div>
                                                @else
