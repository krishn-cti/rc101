                            ...
                            <div class="card-body">
                                ...
                                <form action="{{url('cms/event-coverage-update')}}" method="POST" id="editEventCoverage" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="event_coverage_link" class="mb-2">Event Coverage Link</label>
                                                <input type="text" class="form-control ct_input" name="event_coverage_link" placeholder="Event Coverage Link" value="{{ old('event_coverage_link', $eventCoverageData->event_coverage_link) }}">
                                                @error('event_coverage_link')
                                                <div class="text text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
...
<script>
    ...
    ClassicEditor.create(document.querySelector('#event_coverage_description'), {
        plugins: [
            Essentials,
            Paragraph,
            Heading,
