                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table sparc-rule-data-table table-responsive table-bordered table-hover mb-0" id="sparcRuleTable">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Title</th>
    ...
    $(function() {
        var table = $('.sparc-rule-data-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'sparc_rule_title',
                    name: 'sparc_rule_title'
                },
                {
                    data: 'sparc_rule_description',
                    name: 'sparc_rule_description'
                },
                {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.error) {
                                ...
                                $('#sparcRuleTable').DataTable().ajax.reload(null, false);
                            }
                        },
