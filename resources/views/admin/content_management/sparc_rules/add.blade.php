                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Add Sparc Rule</h3>
                                    <a href="{{url('cms/sparc-rule-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/sparc-rule-save')}}" method="POST" id="addSparcRule" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="sparc_rule_title" class="mb-2">Sparc Rule Title</label>
                                                <input type="text" class="form-control ct_input" name="sparc_rule_title" placeholder="Sparc Rule Title" value="{{ old('sparc_rule_title')}}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control ct_input" name="sparc_rule_description" id="sparc_rule_description" placeholder="Sparc Rule Description">{{ old('sparc_rule_description')}}</textarea>
