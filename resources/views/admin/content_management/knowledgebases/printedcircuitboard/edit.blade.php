                        ...
                        <div class="card">
                            <div class="card-body">
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Printed Circuit Board</h3>
                                    <a href="{{url('cms/knowledgebases/printed-circuit-board-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/knowledgebases/printed-circuit-board-update')}}" method="POST" id="editPrintedCircuitBoard" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{$printedCircuitBoardData->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="title" class="mb-2">Title</label>
                                                <input type="text" class="form-control ct_input" name="title" placeholder="Title" value="{{ old('title', $printedCircuitBoardData->title) }}">
                                                @error('title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="description" id="description" placeholder="Description">{{ old('description', $printedCircuitBoardData->description) }}</textarea>
                                                @error('description')
                                                <div class="text text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                @if(!empty($printedCircuitBoardData->image))

                                                <div id="imagePreviewWrapper" class="mt-2" style="display: 'block';">
                                                    <img id="imagePreview" src="{{ $printedCircuitBoardData->image }}" alt="Current Image" style="width: 100px; height: 100px; border-radius: 8px;">
                                                </div>
                                                @else
...
<script>
    $(document).ready(function() {
        $('#editPrintedCircuitBoard').validate({
            ignore: [],
            rules: {
                title: {
                    required: true,
