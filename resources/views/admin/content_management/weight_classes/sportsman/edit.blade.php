                        ...
                        <div class="card">
                            <div class="card-body">
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Sportsman</h3>
                                    <a href="{{url('cms/weight-classes/sportsman-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/weight-classes/sportsman-update')}}" method="POST" id="editThinkercad" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{$sportsmanData->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="weight_class_title" class="mb-2">Weight Class Title</label>
                                                <input type="text" class="form-control ct_input" name="weight_class_title" placeholder="Weight Class Title" value="{{ old('weight_class_title', $sportsmanData->weight_class_title) }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="weight_class_description" id="weight_class_description" placeholder="Weight Class Description">{{ old('weight_class_description', $sportsmanData->weight_class_description) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                @if(!empty($sportsmanData->weight_class_image) && file_exists(public_path('cms_images/weight/sportsmans/' . $sportsmanData->weight_class_image)))

                                                <div id="imagePreviewWrapper" class="mt-2" style="display: 'block';">
                                                    <img id="imagePreview" src="{{ asset('cms_images/weight/sportsmans/'.$sportsmanData->weight_class_image) }}" alt="Current Image" style="width: 100px; height: 100px; border-radius: 8px;">
                                                </div>
                                                @else
