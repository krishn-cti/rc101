                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Add Hobbyweight</h3>
                                    <a href="{{url('cms/weight-classes/hobbyweight-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/weight-classes/hobbyweight-save')}}" method="POST" id="addHobbyweight" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
