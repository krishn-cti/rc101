                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Weight Class</h3>
                                    <a href="{{url('cms/weight-class-list')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('cms/weight-class-update')}}" method="POST" id="editWeightClass" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{$weightClassData->id}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="weight_class_title" class="mb-2">Weight Class Title</label>
                                                <input type="text" class="form-control ct_input" name="weight_class_title" placeholder="Weight Class Title" value="{{ old('weight_class_title', $weightClassData->weight_class_title) }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="weight_class_description" id="weight_class_description" placeholder="Weight Class Description">{{ old('weight_class_description', $weightClassData->weight_class_description) }}</textarea>
