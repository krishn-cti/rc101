                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <a href="{{url('list-sub-category')}}"> <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('save-sub-category')}}" method="POST" id="addCategory" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <label for="" class="mb-2">Sub Category Name</label>
                                                <input type="text" class="form-control ct_input" name="sub_category_name" placeholder="Sub Category Name" value="{{ old('category_name')}}">
